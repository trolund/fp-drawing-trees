...
let n3 =
    Node(
        "NODE1",
        [ Node("NODE2", [ Node("NODE4", []); Node("NODE5", []) ])
          Node("NODE3", [ Node("NODE6", []); Node("NODE7", []) ]) ]
    )
...
let n6 =
    Node("NODE1", [ Node("NODE2", [ Node("NODE3", [ Node("NODE4", [ Node("NODE5", []) ]) ]) ]) ])
    ...
    Node(
        ...
        [ Node("NODE2", [])
          Node(
              "NODE3",
              [ Node("NODE4", [])
                Node("NODE5", [ Node("NODE6", []); Node("NODE7", []) ]) ]
          ) ]
    )
...
let n8 =
    Node(
        ...
        [ Node(
            "NODE2",
            [ Node("NODE4", [ Node("NODE6", []); Node("NODE7", []) ])
              Node("NODE5", []) ]
          )
          Node("NODE3", []) ]
    )
    ...
    Node(
        ...
        [ Node(
            ...
            [ Node(
              ...
              Node("NODE8", [ fact; n3; n2; n1; fact ])
              Node(
                  "NODE9",
                  [ Node("NODE10", [ fact; n1; n5; n6 ])
                    Node("NODE11", [ n7 ])
                    Node("NODE12", [ n2 ])
                    Node("NODE13", [ n8 ]) ]
              ) ]
...
let avg l =
    let sum, count =
        List.fold (fun (s, c) v -> (s + v, c + 1.)) (0., 0.) l
...
let performanceTest () =
    ...
    let res =
        multiRunFlet 1000 (fun t -> toPSfast t) (fun t -> toPSslow t) t10
